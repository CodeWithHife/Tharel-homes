    ...
    <main style={{ backgroundColor: "#F8FAFC", padding: "140px 20px 60px", minHeight: "100vh" }}>
      <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "6px", color: "#475569" }}>
            <Maximize size={18} /> {property.size}
          </div>
        </div>
        ...
        <p style={{ color: "#334155", lineHeight: 1.7, marginBottom: "28px" }}>
        ...
        >
          <h3 style={{ fontFamily: "Montserrat, sans-serif", fontWeight: 700, marginBottom: "10px" }}>
            Title & Payment
          </h3>
          ...
          <p>
            <strong>Payment Plan:</strong> {property.paymentPlan}
          </p>
        </div>
